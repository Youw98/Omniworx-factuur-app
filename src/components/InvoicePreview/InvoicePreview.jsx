    ...
    >
      ...
      <div style={{
        ...
        <div style={{ textAlign: textAlignEnd, fontSize: 12, lineHeight: 1.85 }}>
          ...
          <div style={{ color: BRAND_GOLD, fontWeight: 700, marginTop: 3 }}>IBAN: {COMPANY.iban}</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ flex: '1 1 auto' }}>
          ...
          <div style={{ fontSize: 13, lineHeight: 2, color: '#374151' }}>
            <div>
              <span style={{ color: '#6b7280', marginInlineEnd: 8 }}>{t('invoice_number')}:</span>
            ...
            <div>
              <span style={{ color: '#6b7280', marginInlineEnd: 8 }}>{t('due_date')}:</span>
